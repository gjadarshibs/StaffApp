package utils.packages.local_storage.android.src.main.java.com.storage.fluttersecurestorage;
...
import com.storage.fluttersecurestorage.ciphers.StorageCipher;
import com.storage.fluttersecurestorage.ciphers.StorageCipher18Implementation;
...
public class FlutterSecureStoragePlugin implements MethodCallHandler, FlutterPlugin {
    ...
    public void initInstance(BinaryMessenger messenger, Context context) {
        try {
            ...
            channel = new MethodChannel(messenger, "plugins.storage/flutter_secure_storage");
