package utils.packages.keychain_keystore_storage.android.src.main.java.com.ibsplc.keychainkeystoreplugin;
...
import com.ibsplc.keychainkeystoreplugin.ciphers.StorageCipher;
import com.ibsplc.keychainkeystoreplugin.ciphers.StorageCipher18Implementation;
...
/**
 * KeychainkeystorepluginPlugin
 */
public class KeychainKeystorePlugin implements MethodCallHandler, FlutterPlugin {
    ...
    public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "keychainkeystoreplugin");
        channel.setMethodCallHandler(new KeychainKeystorePlugin());
    }
    ...
    public void initInstance(BinaryMessenger messenger, Context context) {
        try {
            ...
            channel = new MethodChannel(messenger, "keychainkeystoreplugin");
    ...
    private boolean write(String key, String value) throws Exception {
        try {
            ...
            try {
                ...
                switch (call.method) {
                    case "write": {
                        ...
                        boolean status = write(key, value);
